...
//Input TV's model
var tvModel = "UE32F6330";

//Input driver's name
var driverName = "Samsung (Net)";
 
var macInfo = IR.GetCurrentLocalIPInfo();
var myTV = new Samsung_net_main(driverName, macInfo[0].MAC, macInfo[0].IP, tvModel);
...
function Samsung_net_main(in_device_name, in_mac, in_myIP, in_TV_model)
{
 //Driver Data
