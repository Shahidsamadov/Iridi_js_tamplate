var SourceSelector = function(switchLogic) {
   ...
   this.selectSATTV = function() {
      ...
      var nvidiaTV_IsOn = IR.GetVariable("Global.SourceNvidiaShield_TV");
      ...
      var nvidiaPR_IsOn = IR.GetVariable("Global.SourceNvidiaShield_PR");
      ...
      } else if (nvidiaTV_IsOn == 1) {
         IR.Log("TV>TV | NvidiaShield>SAT");
         this.switchLogic.TVtoTV_NvidiaShieldtoSAT();
      ...
      } else if (nvidiaPR_IsOn == 1) {
         IR.Log("PR>TV | NvidiaShield>SAT");
         this.switchLogic.PRtoTV_NvidiaShieldtoSAT();
      } else if (fmAU_IsOn == 1) {
   ...
   this.selectMediaplayerTV = function() {
      ...
      if (satTV_IsOn == 1) {
         ...
         IR.Log("TV>TV | NvidiaShield>Mediaplayer");
         this.switchLogic.TVtoTV_NvidiaShieldtoMediaplayer();
      } else if (nvidiaPR_IsOn == 1) {
         IR.Log("PR>TV | NvidiaShield>Mediaplayer");
         this.switchLogic.PRtoTV_NvidiaShieldtoMediaplayer();      
      } else {
   ...
   this.selectBlurayTV = function() {
      ...
      if (satTV_IsOn == 1) {
         ...
         IR.Log("TV>TV | NvidiaShield>Bluray");
         this.switchLogic.TVtoTV_NvidiaShieldtoBluray();
      } else if (nvidiaPR_IsOn == 1) {
         IR.Log("PR>TV | NvidiaShield>Bluray");
         this.switchLogic.PRtoTV_NvidiaShieldtoBluray(); 
      } else {
   ...
   this.selectSmartTVTV = function() {
      ...
      if (satTV_IsOn == 1) {
         ...
         IR.Log("TV>TV | NvidiaShield>SmartTV");
         this.switchLogic.TVtoTV_NvidiaShieldtoSmartTV();
      } else if (nvidiaPR_IsOn == 1) {
         IR.Log("PR>TV | NvidiaShield>SmartTV");
         this.switchLogic.PRtoTV_NvidiaShieldtoSmartTV();
      } else {
   ...
   this.selectNvidiaShieldTV = function() {
      IR.Log("NvidiaShield TV select");
      var satTV_IsOn = IR.GetVariable("Global.SourceSAT_TV");
      var mediaplayerTV_IsOn = IR.GetVariable("Global.SourceMediaplayer_TV");
      var blurayTV_IsOn = IR.GetVariable("Global.SourceBluray_TV");
      var smartTVTV_IsOn = IR.GetVariable("Global.SourceSmartTV_TV");
      ...
      var nvidiaPR_IsOn = IR.GetVariable("Global.SourceNvidiaShield_PR");
      if (satTV_IsOn == 1) {
         IR.Log("TV>TV | SAT>NvidiaShield");
         this.switchLogic.TVtoTV_SATtoNvidiaShield();
      } else if (mediaplayerTV_IsOn == 1) {
         IR.Log("TV>TV | MediaPlayer>NvidiaShield");
         this.switchLogic.TVtoTV_MediaplayertoNvidiaShield();
      } else if (blurayTV_IsOn == 1) {
         IR.Log("TV>TV | Bluray>NvidiaShield");
         this.switchLogic.TVtoTV_BluraytoNvidiaShield();
      } else if (smartTVTV_IsOn == 1) {
         IR.Log("TV>TV | SmartTV>NvidiaShield");
         this.switchLogic.TVtoTV_SmartTVtoNvidiaShield();
      } else if (satPR_IsOn == 1) {
         IR.Log("PR>TV | SAT>NvidiaShield");
         this.switchLogic.PRtoTV_SATtoNvidiaShield();
      } else if (mediaplayerPR_IsOn == 1) {
         IR.Log("PR>TV | Mediaplayer>NvidiaShield");
         this.switchLogic.PRtoTV_MediaplayertoNvidiaShield();
      } else if (blurayPR_IsOn == 1) {
         IR.Log("PR>TV | Bluray>NvidiaShield");
         this.switchLogic.PRtoTV_BluraytoNvidiaShield();
      } else if (fmAU_IsOn == 1) {
         IR.Log("AU>TV | FM>NvidiaShield");
         this.switchLogic.AUtoTV_FMtoNvidiaShield();
      } else if (btAU_IsOn == 1) {
         IR.Log("AU>TV | BT>NvidiaShield");
         this.switchLogic.AUtoTV_BTtoNvidiaShield();
      } else {
         IR.Log("NO>TV | No>NvidiaShield");
         this.switchLogic.NOtoTV_NOtoNvidiaShield();
      }   
   }
   ...
   this.selectSATPR = function() {
      ...
      if (satTV_IsOn == 1) {
         ...
         IR.Log("TV>PR | NvidiaShield>SAT");
         this.switchLogic.TVtoPR_NvidiaShieldtoSAT();
      } else if (nvidiaPR_IsOn == 1) {
         IR.Log("PR>PR | NvidiaShield>SAT");
         this.switchLogic.PRtoPR_NvidiaShieldtoSAT();
      } else {
         IR.Log("NO>PR | No>SAT");
   ...
   this.selectMediaplayerPR = function() {
      ...
      if (satTV_IsOn == 1) {
         ...
         IR.Log("TV>PR | NvidiaShield>Mediaplayer");
         this.switchLogic.TVtoPR_NvidiaShieldtoMediaplayer();
      } else if (nvidiaPR_IsOn == 1) {
         IR.Log("PR>PR | NvidiaShield>Mediaplayer");
         this.switchLogic.PRtoPR_NvidiaShieldtoMediaplayer();
      } else {
   ...
   this.selectBlurayPR = function() {
      ...
      if (satTV_IsOn == 1) {
         ...
         IR.Log("TV>PR | NvidiaShield>Bluray");
         this.switchLogic.TVtoPR_NvidiaShieldtoBluray();
      } else if (nvidiaPR_IsOn == 1) {
         IR.Log("PR>PR | NvidiaShield>Bluray");
         this.switchLogic.PRtoPR_NvidiaShieldtoBluray();
      } else {
   ...
   this.selectNvidiaShieldPR = function() {
      IR.Log("NvidiaShield PR select");
      var satTV_IsOn = IR.GetVariable("Global.SourceSAT_TV");
      var mediaplayerTV_IsOn = IR.GetVariable("Global.SourceMediaplayer_TV");
      var blurayTV_IsOn = IR.GetVariable("Global.SourceBluray_TV");
      var smartTVTV_IsOn = IR.GetVariable("Global.SourceSmartTV_TV");
      ...
      var nvidiaPR_IsOn = IR.GetVariable("Global.SourceNvidiaShield_PR");
      if (satTV_IsOn == 1) {
         IR.Log("TV>PR | SAT>NvidiaShield");
         this.switchLogic.TVtoPR_SATtoNvidiaShield();
      } else if (mediaplayerTV_IsOn == 1) {
         IR.Log("TV>PR | MediaPlayer>NvidiaShield");
         this.switchLogic.TVtoPR_MediaplayertoNvidiaShield();
      } else if (blurayTV_IsOn == 1) {
         IR.Log("TV>PR | Bluray>NvidiaShield");
         this.switchLogic.TVtoPR_BluraytoNvidiaShield();
      } else if (smartTVTV_IsOn == 1) {
         IR.Log("TV>PR | SmartTV>NvidiaShield");
         this.switchLogic.TVtoPR_SmartTVtoNvidiaShield();
      } else if (satPR_IsOn == 1) {
         IR.Log("PR>PR | SAT>NvidiaShield");
         this.switchLogic.PRtoPR_SATtoNvidiaShield();
      } else if (mediaplayerPR_IsOn == 1) {
         IR.Log("PR>PR | Mediaplayer>NvidiaShield");
         this.switchLogic.PRtoPR_MediaplayertoNvidiaShield();
      } else if (blurayPR_IsOn == 1) {
         IR.Log("PR>PR | Bluray>NvidiaShield");
         this.switchLogic.PRtoPR_BluraytoNvidiaShield();
      } else if (fmAU_IsOn == 1) {
         IR.Log("AU>PR | FM>NvidiaShield");
         this.switchLogic.AUtoPR_FMtoNvidiaShield();
      } else if (btAU_IsOn == 1) {
         IR.Log("AU>PR | BT>NvidiaShield");
         this.switchLogic.AUtoPR_BTtoNvidiaShield();
      } else {
         IR.Log("NO>PR | No>NvidiaShield");
         this.switchLogic.NOtoPR_NOtoNvidiaShield();
      }   
   }
   ...
   this.selectFMAU = function() {
      ...
      if (satTV_IsOn == 1) {
         ...
         IR.Log("TV>AU | NvidiaShield>FM");
         this.switchLogic.TVtoAU_NvidiaShieldtoFM();
      } else if (nvidiaPR_IsOn == 1) {
         IR.Log("PR>AU | NvidiaShield>FM");
         this.switchLogic.PRtoAU_NvidiaShieldtoFM();
      } else {
         IR.Log("NO>AU | No>FM");
   ...
   this.selectBTAU = function() {
      ...
      if (satTV_IsOn == 1) {
         ...
         IR.Log("TV>AU | NvidiaShield>BT");
         this.switchLogic.TVtoAU_NvidiaShieldtoBT();
      } else if (nvidiaPR_IsOn == 1) {
         IR.Log("PR>AU | NvidiaShield>BT");
         this.switchLogic.PRtoAU_NvidiaShieldtoBT();
      } else {
         IR.Log("NO>AU | No>BT");
   ...
   this.selectOff = function() {
      ...
      if (satTV_IsOn == 1) {
         ...
         IR.Log("TV>NO | NvidiaShield>BT");
         this.switchLogic.TVtoNO_NvidiaShieldtoNO();
      } else if (nvidiaPR_IsOn == 1) {
         IR.Log("PR>NO | NvidiaShield>BT");
         this.switchLogic.PRtoNO_NvidiaShieldtoNO();
      } else {
         IR.Log("NO>NO | No>No");
      }
   } 
