var OnkyoDevice = function(DeviceName)
{
  ...
  var BassTrebleRegex = /!1(TFR)(.*)/g;
  var valpr;
  
   this.radioModule;
  
   this.setRadioModule = function(radioModule) {
  ...
  { 
    ...
    QueueCommands.push("!1TUNQSTN");
    QueueCommands.push("!1TFRQSTN");
    QueueCommands.push("!1LMDQSTN");
...
//-----------------------------------------------------------------------------------------
		var msg = null;
      BassTrebleRegex = /!1(TFR)(.*)/g;
      msg = BassTrebleRegex.exec(FinishStr);
      if (msg != null)
      {
         var tr = IR.GetPopup("PopupSettings").GetItem("tr");
         var bs = IR.GetPopup("PopupSettings").GetItem("bs");
         var strrrr = FinishStr.slice(12, FinishStr.length-3);
         var bassVal = strrrr.slice(0, 3);
         var trebleVal = strrrr.slice(3, 6);
         switch (bassVal) {
            case "B-A":
               bs.Text = "-10 dB";
            break;
      ...
      ListeningModeRegex = /!1(LMD|LMZ)(.*)/g;
         ...
         switch(checkzone)
         {
            case '1':
              switch(id)
              {
         		...
         		break;
         		case "03":
         		  ListeningModeName = 'Game-RGB';
         		break;
               case "04":
         		  ListeningModeName = 'THX';
         		break; 
               case "05":
         		  ListeningModeName = 'Game-Action';
         		break;
               case "06":
         		  ListeningModeName = 'Game-Rock';
         		break;
               case "07":
               ...
               case "8A":
         		...
         		break;
               case "8B":
                 ListeningModeName = 'PLII THX Music';
               break;
               case "8C":
                 ListeningModeName = 'Neo:6 THX Music';
               break;	
         	  };
...
//----------------------------------------------------------------------------------------- 
  ...
  this.publicCreatePacket = function(curzone, cmd, vallvl) {
