...
var MoveControl = function(popupName, itemName, crestron, canSend, moveDif) {
   ...
   IR.AddListener(IR.EVENT_MOUSE_DOWN, this.item, press);
   IR.AddListener(IR.EVENT_TOUCH_DOWN, this.item, press);
   function press() {
   ...
   IR.AddListener(IR.EVENT_MOUSE_UP, this.item, release);
   IR.AddListener(IR.EVENT_TOUCH_UP, this.item, release);
   function release() {
      that.curX = that.item.ValueX;
      that.curY = that.item.ValueY;
   ...
   IR.AddListener(IR.EVENT_MOUSE_MOVE, this.item, move);
   IR.AddListener(IR.EVENT_TOUCH_MOVE, this.item, move);
   function move() {
      that.curX = that.item.ValueX;
      that.curY = that.item.ValueY;
